Neutron-qt: Qt5 GUI for Neutron
===============================
...
::
    ...
    apt-get install qt5-default qt5-qmake qtbase5-dev-tools qttools5-dev-tools \
        ...
        libssl-dev libdb++-dev libminiupnpc-dev libssl1.0-dev libtool
...
A warning for people using the *static binary* version of Neutron on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of Neutron is linked against libdb 5.0 (see also `this Debian issue`_).
